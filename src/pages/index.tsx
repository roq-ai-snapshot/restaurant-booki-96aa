  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine - Streamlining table reservations and menu management for a seamless dining experience. Your restaurant, managed effortlessly."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine - Streamlining table reservations and menu management for a seamless dining experience. Your restaurant, managed effortlessly.`}
            </Text>
            <Box
